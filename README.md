...
## ChatGPT Usage
- The evaluation for the neural network.
- Implementation of He Initialization and converting [Wikipedia's Box-Muller Transform C++ implementation](https://en.wikipedia.org/wiki/Box-Muller_transform#Implementation) into C.
- Debugging and understanding the math behind backpropogation.
